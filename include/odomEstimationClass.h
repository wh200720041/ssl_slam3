...
public:
	...
	void addLidarFeature(const pcl::PointCloud<PointType>::Ptr edge_in, const pcl::PointCloud<PointType>::Ptr surf_in);
	void optimize(void);
...
private:
	...
	// map points
	pcl::PointCloud<PointType>::Ptr edge_map;
	pcl::PointCloud<PointType>::Ptr surf_map;
	pcl::PointCloud<PointType>::Ptr current_edge_points;
	pcl::PointCloud<PointType>::Ptr current_surf_points;

	std::deque<pcl::PointCloud<PointType>::Ptr> deque_edge, deque_surf;

	// kdtree for fast indexing
	pcl::KdTreeFLANN<PointType> edge_kd_tree;
	pcl::KdTreeFLANN<PointType> surf_kd_tree;
